...
;; lsp-mode's Odin client otherwise points at its own download location and
;; prompts to install ols, even when Nix already provides it in PATH.
(setq lsp-odin-ols-binary-path
      (or (executable-find "ols") "ols"))
